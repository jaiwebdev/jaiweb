<!doctype html>
    ...
    <head>
        ...
        <title>www.jayavelweb.com</title>
        ...
        <header class="head">
            <div class="logo border-bottom">
                <img class="w-100" src="assets/images/logo2.jpg" alt="" />
        ...
        <div  class="main-content">
            ...
            <div class="profile-head">
               <div class="row vh-100">
                   <div class="col-xl-6 text-center mx-auto align-self-center ">
                        ...
                        <b class="fs-6">Hello I am, Jayavel Murugesan</b>
                        <h1 class="fw-bold mb-4 fs-1">WEB DEVELOPER</h1>
            ...
            <div id="about" class="about px-4 bg-white py-5">
                ...
                <div class="row">
                    <div class="col-md-7">
                        <p><b>I am, Jayavel</b></p>
                        <p class="pt-2 fs-6 text-justify">iam Web Developer I started my coding journey almost exactly a year ago and now I'm working full time and doing freelance projects on the side for my friends
 You may have noticed from my portfolio, but I'm obsessed with unique, interesting design and user-friendly functionality so hit me up with your weird artistic project ideas or app proposals.Provided front-end website development using WordPress, Hubspot and other editing software.
Designed, implemented and monitored web pages plugins and functionality for continuous improvement.Built website interfaces with HTML and CSS. Pulled from PHP, SQL, JavaScript and backend knowledge code using in websites</p>
                        ...
                        <div class="row skill-set">
                            ...
                            <div class="col-md-6 py-3">
                                <h6 class="fw-bold">Web Design</h6>
                                <div class="progress">
                            ...
                            <div class="col-md-6 py-3">
                                <h6 class="fw-bold">World press</h6>
                                <div class="progress">
            ...
            <div id="service" class="service px-4 py-5">
                 <div class="titie-row row mb-3">
                    ...
                    <p>As a service provider in today world, you know that the best way to reach potential customers is online</p>
                </div>
                <div class="row mt-5">
                    <div class="col-lg-4 col-md-6 mb-4">
                       <div class="serv-cove shadow-md rounded bg-white text-center p-4">
                            ...
                            <p>Web design refers to the design of websites. It usually refers to the user experience aspects of website development</p>
                       </div>
                    </div>
                     ...
                     <div class="col-lg-4 col-md-6 mb-4">
                       <div class="serv-cove shadow-md rounded bg-white text-center p-4">
                            ...
                            <p>UX design involves managing the user journey as they interact with a product, while UI design focuses on the actual</p>
                       </div>
                    </div>
                     ...
                     <div class="col-lg-4 col-md-6 mb-4">
                       <div class="serv-cove shadow-md rounded bg-white text-center p-4">
                            ...
                            <p>Front-end developers focus on the user-facing side of their work, while back-end developers make websites </p>
                       </div>
                    </div>
                     ...
                     <div class="col-lg-4 col-md-6 mb-4">
                       <div class="serv-cove shadow-md rounded bg-white text-center p-4">
                            ...
                            <p>The process of creating applications for devices running an Android operating system Android Studio is the official</p>
                       </div>
                    </div>
                     ...
                     <div class="col-lg-4 col-md-6 mb-4">
                       <div class="serv-cove shadow-md rounded bg-white text-center p-4">
                            ...
                            <p>the process of making mobile applications for Apple hardware, including iPhone, iPad and iPod Touch </p>
                       </div>
                    </div>
                     ...
                     <div class="col-lg-4 col-md-6 mb-4">
                       <div class="serv-cove shadow-md rounded bg-white text-center p-4">
                            ...
                            <p> The products and services and mobile devices, and social media platforms,effectiveness of their campaigns.</p>
                       </div>
                    </div>
                </div>
            </div>
                    ...
                    <!-- <div class="col-lg-4 col-md-6 mb-4">
                     ...
                     <div class="col-lg-4 col-md-6 mb-4">
                       <div class="serv-cove shadow-md rounded bg-white p-2">
                            ...
                            <h5 class="mt-3 fs-6 fw-bold">Provide for Design & Developement</h5>
                       </div>
                    </div>
                     <div class="col-lg-4 col-md-6 mb-4">
                       <div class="serv-cove shadow-md rounded bg-white p-2">
                            <img src="assets/images/blog/5.jpg" alt="">
                            <h5 class="mt-3 fs-6 fw-bold">Team frequently in retailing</h5>
                       </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
                       <div class="serv-cove shadow-md rounded bg-white p-2">
                            <img src="assets/images/blog/6.jpg" alt="">
                            <h5 class="mt-3 fs-6 fw-bold">Network is intangible in nature</h5>
                       </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row mt-5">
                    <div class="col-lg-4 col-md-6 mb-4">
                       <div class="serv-cove rounded bg-white p-2">
                            <img src="assets/images/blog/1.jpg" alt="">
                            <div class="p-2">
                                <h5 class="mt-3 fs-7 fw-bold">Service is intangible in nature</h5>
                            </div>
                       </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
                       <div class="serv-cove rounded bg-white p-2">
                            <img src="assets/images/blog/2.jpg" alt="">
                            <div class="p-2">
                                <h5 class="mt-3 fs-7 fw-bold">Occurs frequently in retailing</h5>
                            </div>
                       </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
                       <div class="serv-cove rounded bg-white p-2">
                            <img src="assets/images/blog/3.jpg" alt="">
                            <div class="p-2">
                                <h5 class="mt-3 fs-7 fw-bold">Provided to a customer</h5>
                            </div>
                       </div>
                    </div>
            ...
            <div class="service px-4 py-5">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="shadow-md row p-4 m-0 rounded bg-white">
                            ...
                            <div class="col-md-9">
                                ...
                                <ul>
                                    <li>+91 95141 27195</li>
                                    <li>+91 93847 23031</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="shadow-md row p-4 m-0 rounded bg-white">
                            ...
                            <div class="col-md-9">
                                ...
                                <ul>
                                    <li>jayavelweb930@gmail.com</li>
                                    <li>jayavelbca219@gmail.com</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="shadow-md row p-4 m-0  rounded bg-white">
                            ...
                            <div class="col-md-9">
                                ...
                                <ul>
                                    <li style='font-size:14.5px;'>152/1, Sathya Nagar, Chettichavadi, Salem - 636008</li>
                ...
                <div id="contact" class="contact-row m-0 row">
                    <div class="col-md-6">
                        <div class="shadow-md p-4 rounded bg-white">
                            ...
                            <form action="" method="post">
                                 <div class="mb-3">
                                  <label for="exampleFormControlInput1" class="form-label fw-bolder fs-8">Enter Mobile</label>
                                  <input type="text" class="form-control" name="mobile" id="exampleFormControlInput1" placeholder="Enter Subject">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                  <label for="exampleFormControlTextarea1" class="form-label fw-bolder fs-8">Example Message</label>
                                  <textarea class="form-control" placeholder="Enter Message" name="message" id="exampleFormControlTextarea1" rows="3"></textarea>
                                </div>
                                <div class="mb-3">
								<input class="btn btn-outline-primary fw-bolder fs-7 px-4 py-2 mt-3 rounded-pill" type="submit" value="Send" name="save" id="save"  />
								</div>
                            </form>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="shadow-md p-4 rounded bg-white">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2123.702835804488!2d78.15181384886266!3d11.723009344720765!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3babf0d711aa0865%3A0x32cbc96bc5723b51!2sPuthupatti%20Shri%20Mariamman%20Kovil!5e1!3m2!1sen!2sin!4v1715669302683!5m2!1sen!2sin" style="width:100%" height="340" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
            </div>
...
if (isset($_POST['save'])) {
	...
	$to = "jayavelweb930@gmail.com";
	$subject="Message From Web";
	$htmlContent = '
	<html>
	<head>
		<title>Jayavel Web</title>
	</head>
	<body>
	<center>
		<h1><font color="green">Mobile No'.$mobile.'</font></h1>
		</br>
		<h1><font color="green">Email'.$email.'</font></h1>
		</br>
		<h1><font color="green">Messgae'.$message.'</font></h1>
		</br>
	</center>
	</body>
	</html>';
